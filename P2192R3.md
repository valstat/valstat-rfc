...
This is not run time requirement. This is operational environment requirement. Operational environment can be satellite in an orbit, or physical server in a data center.
